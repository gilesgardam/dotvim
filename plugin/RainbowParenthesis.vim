...
hi level1c ctermfg=green
hi level2c ctermfg=lightyellow
hi level3c ctermfg=white
hi level4c ctermfg=darkmagenta
hi level5c ctermfg=blue
hi level6c ctermfg=lightcyan
hi level7c ctermfg=green
hi level8c ctermfg=lightyellow
hi level9c ctermfg=brown
hi level10c ctermfg=red
hi level11c ctermfg=white
hi level12c ctermfg=darkmagenta
hi level13c ctermfg=blue
hi level14c ctermfg=lightcyan
hi level15c ctermfg=green
hi level16c ctermfg=lightyellow
